...
>
> Reads against, and defers to in this order: (1) `BUSINESS_RULES.md`
...
- **Acceptance:** six decisions written into `BUSINESS_RULES.md` as a
...
- **Files:** `AGENTS.md` (the 97/3–80/20 correction is done; Socket.io and `isFrozen` are not),
  `STATUS.md` (it contradicts itself, L1, and `AGENTS.md` calls it the live source of
