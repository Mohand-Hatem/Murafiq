...
- `PHASES_INDEX.md` — the master checklist and phase order.
- `PROJECT_RULES.md` — the mandatory process contract for developers and AI agents.
- `STATUS.md` — verified state of what is real vs. skeleton/placeholder.
- `ROUTES.md` — route dictionary with active status indicators.
